...
<head>
  ...
  <link href="<?=config_item('base_url') ?>assets/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
      ...
      <div id="content">
        ...
        <div class="container-fluid mt-5">
          ...
          <div class="text-center">
            ...
            <a href="<?=config_item('base_url') ?>admin">&larr; Back to Dashboard</a>
          </div>
